  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the ResumeGPT
      ...
      <Paragraph>
        And that is everything about the ResumeGPT parser algorithm :)
      </Paragraph>
      <Paragraph>
        Written by <Link href="https://github.com/amatun-nooor">Amatun Noor</Link> on
        March 2024
      </Paragraph>
    </article>
  );
